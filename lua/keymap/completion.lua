...
local plug_map = {
	...
	["n|<leader>sld"] = map_cr("Lspsaga show_line_diagnostics")
		:with_noremap()
		:with_silent()
	...
	["n|D"] = map_cr("Lspsaga hover_doc"):with_noremap():with_silent():with_desc("lsp: Show doc"),
	...
	["n|fm"] = map_cr("Format"):with_noremap():with_silent():with_desc("lsp: Format file"),
